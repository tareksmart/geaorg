...
namespace sales_pro {
    ...
    public partial class salesDataSet : global::System.Data.DataSet {
        ...
        public partial class CategoryDataTable : global::System.Data.TypedTableBase<CategoryRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CategoryRow AddCategoryRow(int UserId, string Notes, string CatName) {
...
namespace sales_pro.salesDataSetTableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Category] WHERE (([CatId] = @Original_CatId) AND ((@IsNull_UserId = 1 AND [UserId] IS NULL) OR ([UserId] = @Original_UserId)) AND ((@IsNull_Notes = 1 AND [Notes] IS NULL) OR ([Notes] = @Original_Notes)) AND ((@IsNull_CatName = 1 AND [CatName] IS NULL) OR ([CatName] = @Original_CatName)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Category] ([UserId], [Notes], [CatName]) VALUES (@UserId, @Not" +
                "es, @CatName);\r\nSELECT CatId, UserId, Notes, CatName FROM Category WHERE (CatId " +
                "= SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Category] SET [UserId] = @UserId, [Notes] = @Notes, [CatName] = @CatName WHERE (([CatId] = @Original_CatId) AND ((@IsNull_UserId = 1 AND [UserId] IS NULL) OR ([UserId] = @Original_UserId)) AND ((@IsNull_Notes = 1 AND [Notes] IS NULL) OR ([Notes] = @Original_Notes)) AND ((@IsNull_CatName = 1 AND [CatName] IS NULL) OR ([CatName] = @Original_CatName)));
SELECT CatId, UserId, Notes, CatName FROM Category WHERE (CatId = @CatId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CatId, UserId, Notes, CatName FROM dbo.Category";
        ...
        public virtual int Fill(salesDataSet.CategoryDataTable dataTable) {
        ...
        public virtual salesDataSet.CategoryDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            salesDataSet.CategoryDataTable dataTable = new salesDataSet.CategoryDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(salesDataSet.CategoryDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CatId, global::System.Nullable<int> Original_UserId, string Original_Notes, string Original_CatName) {
        ...
        public virtual int Insert(global::System.Nullable<int> UserId, string Notes, string CatName) {
        ...
        public virtual int Update(global::System.Nullable<int> UserId, string Notes, string CatName, int Original_CatId, global::System.Nullable<int> Original_UserId, string Original_Notes, string Original_CatName, int CatId) {
            if ((UserId.HasValue == true)) {
            ...
            if ((Original_CatName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_CatName));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> UserId, string Notes, string CatName, int Original_CatId, global::System.Nullable<int> Original_UserId, string Original_Notes, string Original_CatName) {
            return this.Update(UserId, Notes, CatName, Original_CatId, Original_UserId, Original_Notes, Original_CatName, Original_CatId);
        }
    }
